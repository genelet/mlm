...
Note that authentication cookie's *Domain* should match exactly the website you are serving in *config.json*. For example, if your site uses no subdomain name *www*, i.e. http://noniland.com[http://noniland.com], then *Domain* should be *noniland.com*. If your site uses *www*, i.e. http://www.noniland.com[http://www.noniland.com], then *Domain* should be *www.noniland.com*.
